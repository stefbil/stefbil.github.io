...
const highlights = [
  {
    icon: GraduationCap,
    title: "MSc Media Technology",
    description: "Sound & Music Computing at Aalborg University",
    color: "text-primary",
  },
  {
    icon: Code,
    title: "M.Eng Graduate",
    description: "Electrical & Computer Engineering from AUTH",
    color: "text-accent",
  },
  {
    icon: Brain,
    title: "ML/AI Experience",
    description: "Computer Vision & NLP at CERTH Research",
    color: "text-primary",
  },
  {
    icon: Music,
          ...
          <ScrollReveal delay={0.1} direction="left">
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                I'm an MSc Student in Media Technology with a unique blend of expertise 
                spanning <span className="text-foreground font-medium">Data Engineering</span>, 
                <span className="text-foreground font-medium"> Machine Learning</span>, and 
                <span className="text-foreground font-medium"> Audio Technology</span>.
              </p>
